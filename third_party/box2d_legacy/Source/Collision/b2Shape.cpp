...
void b2Shape::Destroy(b2Shape*& shape)
{
	...
	// IRISU SAFETY PATCH: r58 inspected m_type after explicitly ending the
	// polymorphic object's lifetime. Preserve the value before destruction.
	const b2ShapeType type = shape->m_type;
	shape->~b2Shape();
