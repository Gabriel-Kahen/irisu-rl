#!/usr/bin/env python3
"""Fresh development-only matched G4 versus R3K long-horizon screen.
...
RUN_ID = "r3k-runway-long-screen-20260808-001"
...
def initialize(run_root: Path) -> dict[str, object]:
    ...
    preregistration = _with_sha(
        {
            "schema": "irisu-r3k-long-screen-preregistration-v1",
...
def _query(
    *,
    ...
    candidates = tuple(evaluator.candidates(observation, incumbent))
