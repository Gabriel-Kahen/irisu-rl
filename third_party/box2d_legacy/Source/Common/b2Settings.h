...
// Memory Allocation
// IRISU SAFETY PATCH: allocation accounting is shared but never coordinates
// physics state, so relaxed atomics preserve independent world execution.
extern std::atomic<int32> b2_byteCount;
