...
ACTOR_GLOBAL_FEATURES = (
    ...
    "previous_injection_acknowledged",
    "previous_requested_left",
    "previous_requested_right",
    "previous_injected_left",
    "previous_injected_right",
    "previous_down_age_seconds_scaled",
    "previous_up_age_seconds_scaled",
    ...
    "previous_effect_confidence",
    "previous_projectile_confirmation_age_seconds_scaled",
    "pending_kind_wait",
    "pending_kind_weak",
    "pending_kind_strong",
    "pending_age_seconds_scaled",
    "pending_injection_acknowledged",
    "pending_requested_left",
    "pending_requested_right",
    "pending_injected_left",
    "pending_injected_right",
...
ACTOR_PREPROCESSING = (
    ...
    "bridge: requested, injected, and injection-acknowledged levels remain distinct",
    "effect: pending/confirmed/missed/ambiguous posterior is distinct from injection acknowledgment",
