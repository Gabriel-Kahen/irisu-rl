...
b2World::~b2World()
{
	// IRISU SAFETY PATCH: r58 only queued the ground body, then discarded the
	// block allocator wholesale. Run normal deferred teardown for every body so
	// shapes, proxies, contacts, and joints die before their broad phase/storage.
	while (m_bodyList)
	{
