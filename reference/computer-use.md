...
claimed window. At implementation time the installed `targeted_pointer_click`
...
current provider capabilities each turn; if explicit targeted down/up is still
absent, keep gameplay input fail-closed. Do not bypass this requirement with
