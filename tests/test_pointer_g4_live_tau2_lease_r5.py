...
def test_r5_live_lease_uses_fresh_screen_source() -> None:
    assert SOURCE.parent.name == "r3j-g4-onpolicy-screen-20260801-005"
    assert Path(LEASE.__file__) == SOURCE
    assert "20260801-004" not in SOURCE.as_posix()
